...
pub use clip::{
    ...
    SpeedPresetSpec, StyleParam, TextAlignH, TextAlignV, TextBackground, TextCase, TextParam,
    TextShadow, TextStroke, TextStyle, audio_gain_at, look_animation_combo_period_ticks,
